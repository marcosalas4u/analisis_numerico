...
def _half_point(interv):
    return float((interv[0]+interv[1])/2)
...
if __name__ == '__main__':
    ...
    while repeat:
        system('cls')
        print('Bienvenido al método de Bisección\n\n')
        bisection_method(read_polynomial())
